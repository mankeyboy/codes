#ifndef __ASS6_13CS30021_TRANSLATOR_H
#define __ASS6_13CS30021_TRANSLATOR_H
...
struct expStruct
{
    ...
    symtab_element *poss_array;                 // stores the base address of the array if the expression is of type array
};
