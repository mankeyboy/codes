...
main:
		...
		sub $sp, $sp, $t0							#Allocate memory for Matrix A
		move $a0, $sp
				
		sub $sp, $sp, $t0							#Allocate memory for Matrix B
		move $a1, $sp 								#Store stack pointer in argument register
		
		move $a2, $s1								#Store Seed s
		move $a3, $s2
